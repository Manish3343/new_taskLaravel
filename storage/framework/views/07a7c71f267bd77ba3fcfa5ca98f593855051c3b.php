                ...
                <div class="col-lg-8">
                    <div class="single-event-details">
                        ...
                        <div class="content">
                            ...
                            <?php elseif($event->available_tickets < 1): ?>
                                <p class="alert alert-danger  margin-top-30"><?php echo e(__('No tickets available')); ?></p>
                            <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vayetech/public_html/@core/resources/views/frontend/pages/events/event-single.blade.php ENDPATH**/ ?>